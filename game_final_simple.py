...
def play_room(room):
    ...
    if(game_state["current_room"] == game_state["target_room"]):
        ...
        print("\nNice work! It took you", time_diff, "seconds to complete the game.\n")
    else:
...
def rock_paper_scissors():
    ...
    level= input("What level would you like to play? Select 'easy' or 'hard': ").lower()
