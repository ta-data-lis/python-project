...
object_relations = {
    ...
    "living_room": [door_c, door_d, dining_table, unknown_stranger],
...
im3 = Image.open("C:/cygwin/home/Cinthya/Ironhack_bootcamp/python-project/your-code/dining_man2.jpg")
im4 = Image.open("C:/cygwin/home/Cinthya/Ironhack_bootcamp/python-project/your-code/squirelfree.jpg")

devolve_image = {
 "game room":im, "bedroom 1":im1, "bedroom 2":im2, "living_room":im3, "outside":im4
}
...
def start_game():
    ...
    Start the game
    """
    text = "You wake up on a couch and find yourself in a strange house with no windows. last time it happened to you, you were really drunk the night before. You don't want to meet an unknow stranger so you must get out of the house, NOW!"
    text_to_speech(text)
    time.sleep(20) #20 works
    starter_sound = "C:/cygwin/home/Cinthya/Ironhack_bootcamp/python-project/your-code/starter.wav"
...
def play_room(room):
    ...
    if(game_state["current_room"] == game_state["target_room"]):
        ...
        sound1 = "C:/cygwin/home/Cinthya/Ironhack_bootcamp/python-project/your-code/fireworks.mp3"
        mixer_noise(sound1)
        #trying to open picture at endgame
...
def examine_item(item_name):
    ...
    for item in object_relations[current_room["name"]]:
        if(item["name"] == item_name):
            ...
            #time.sleep(2)
            if(item["type"] == "door"):
                sound_door_lock = "C:/cygwin/home/Cinthya/Ironhack_bootcamp/python-project/your-code/LOCK_CLO.WAV"
    ...
    if(next_room and call_text_to_speech("Do you want to go to the next room?")==True and input("Enter 'yes' or 'no'").strip()== "yes"):        
        ...
        sound_door_open = "C:/cygwin/home/Cinthya/Ironhack_bootcamp/python-project/your-code/DOOROPEN.WAV"
